import { Utensils, Instagram, MessageCircle, Music2 } from "lucide-react";
...
const socials = [
  ...
  },
  {
    icon: MessageCircle,
    label: "WhatsApp",
    href: "https://wa.me/6281235028932",
...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background: "linear-gradient(160deg, #1F1F1F 0%, #2B2623 100%)",
      }}
    >
      {/* Ambient */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-3 gap-12 pb-12 border-b border-beige-sand/10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="font-inter text-sm text-beige-sand/50 leading-[1.8] mb-6 max-w-xs">
              Nikmati pengalaman kuliner terbaik dengan menu lezat, bahan
              berkualitas, dan pelayanan hangat untuk setiap momen spesial Anda.
            </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
          <p className="font-inter text-xs text-beige-sand/30">
            © {new Date().getFullYear()} Takeway Resto. All rights reserved.
          </p>
